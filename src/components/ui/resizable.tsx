...
const ResizableHandle = ({
  ...
  <Separator
    className={cn(
      // react-resizable-panels v4 renders no `data-panel-group-direction`; the Separator
      // instead carries `aria-orientation`, set to the *opposite* of the group's direction.
      // A vertical panel group -> aria-orientation="horizontal" on the handle, so gate the
      // stacked-bar styling on that.
