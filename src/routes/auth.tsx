    ...
    <main className="flex min-h-screen items-center justify-center bg-background px-5 py-10">
      <div className="w-full max-w-md">
        ...
        <button
          ...
          disabled={busy}
          className="mt-8 flex h-12 w-full items-center justify-center gap-3 rounded-lg border border-border bg-card font-semibold text-foreground shadow-sm transition duration-200 hover:-translate-y-0.5 hover:bg-accent active:translate-y-0 disabled:opacity-60"
        >
          <span className="grid size-5 place-items-center rounded-sm bg-[#5865F2] text-[11px] font-black text-white">
            D
          </span>
